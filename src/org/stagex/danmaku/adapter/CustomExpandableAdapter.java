...
public class CustomExpandableAdapter extends BaseExpandableListAdapter{
	...
	Activity activity;
	public CustomExpandableAdapter(Activity activity, List<String> groupArray, List<List<ChannelInfo>> childArray){
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			...
			viewHolder = new ViewHolder();
			viewHolder.name = (TextView)convertView.findViewById(R.id.channel_name);
			viewHolder.name.setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
//			viewHolder.name.setPadding(60 , 0 , 0 , 0 );
			convertView.setTag(viewHolder);
		}else {
		...
		viewHolder.name.setText(childArray.get(groupPosition).get(childPosition).getName());
        return  convertView; 
	}
